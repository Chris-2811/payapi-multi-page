...
function HeroPricing() {
  return (
    <div className="text-black  text-center lg:text-left">
      <h1 className="fs-800 font-serif text-secondary-100 mb-12 ">Pricing</h1>
      <div className="flex flex-col md:flex-row items-center justify-center gap-[2.5rem]">
        <div className="lg:w-[350px] ">
          <h3 className="text-primary-100 font-serif fs-500 mb-20 font-bold md:mb-3">
            Free Plan
          </h3>
        ...
        <div className="md:grid place-items-center grid-cols-custom-pricing lg:w-[350px] ">
          <h3 className="text-primary-100  font-serif fs-500 mb-20 md:mb-3 font-bold mt-12 md:mt-0">
            Basic Plan
          </h3>
          <p className="hidden md:block lg:hidden">
